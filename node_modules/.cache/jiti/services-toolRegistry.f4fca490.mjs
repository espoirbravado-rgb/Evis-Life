"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ToolRegistry = void 0;
      ...
      execute: async (args) => {
        ...
        try {
          ...
          const lines = (data.items || []).map(
            (item) => `${item.isDirectory ? '[DIR] ' : '      '} ${item.name} (${item.size || 0} bytes)`
          );
          return {
            success: true,
            result: data,
...
}exports.ToolRegistry = ToolRegistry; /* v9-f0c8f14bf1b863f4 */
