"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.INITIAL_SKILLS = exports.INITIAL_SESSIONS = exports.INITIAL_PROJECTS = exports.INITIAL_MODELS = exports.INITIAL_KNOWLEDGE = exports.AVAILABLE_TOOLS = void 0;

// Models are dynamically discovered from active provider hosts (Ollama & llama.cpp)
const INITIAL_MODELS = exports.INITIAL_MODELS = [];

const INITIAL_SKILLS = exports.INITIAL_SKILLS = [
{
  id: 'desktop-notes',
...
const INITIAL_PROJECTS = exports.INITIAL_PROJECTS = [
{
  id: 'proj-evis',
  name: 'Evis Workspace',
...
const INITIAL_KNOWLEDGE = exports.INITIAL_KNOWLEDGE = [
{
  id: 'k-evis-1',
...
const INITIAL_SESSIONS = exports.INITIAL_SESSIONS = [
{
  id: 'sess-main',
  ...
  updatedAt: '2026-09-13T17:42:00Z',
  activeSkillIds: ['file-system', 'desktop-notes', 'memory-curator'],
